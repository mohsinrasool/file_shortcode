...
class FileShortcodes {
	 ...
	 * @since    1.0.0
	 */
	public function install_shortcodes()
	{
		
		add_shortcode( 'shortcode_1', array(&$this, 'shortcode_1') );
		add_shortcode( 'shortcode_2', array(&$this, 'shortcode_2') );
	}



	/**
	 * Implementation of shortcode_1
	 *
	 * @since    1.0.0
	 */
	function shortcode_1($attr)
	{
		...
		if(file_exists($FileLocation)) {
			...
			return 'Shortcode file do not exists';
	}

	/**
	 * Implementation of shortcode_2
	 *
	 * @since    1.0.0
	 */
